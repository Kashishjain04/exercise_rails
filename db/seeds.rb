...
Doctor.create!([
                 ...
                 },
                 {
                   ...
                   "start_time": DateTime.parse("10:00:00"),
                   "break_start_time": DateTime.parse("12:00:00"),
                   "break_end_time": DateTime.parse("13:00:00"),
                 ...
                 },
                 {
                   ...
                   "city": "Melbourne",
                   "image": "doctors/doctor-1.png",
                   "start_time": DateTime.parse("11:00:00"),
                   "break_start_time": DateTime.parse("13:00:00"),
                   "break_end_time": DateTime.parse("15:00:00"),
                   "end_time": DateTime.parse("17:00:00")
                 },
                 {
                   "name": "Jayme Snow",
